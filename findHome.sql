CREATE DATABASE  IF NOT EXISTS `find_home` /*!40100 DEFAULT CHARACTER SET utf8mb4  */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `find_home`;
...
CREATE TABLE `user` (
  ...
  `password` varchar(100) DEFAULT NULL,
  `profileImageURL` varchar(100) CHARACTER SET utf8mb4  DEFAULT NULL,
  PRIMARY KEY (`id`),
