    ...
    return `<div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    ...
                    <a href="checkuser.html" class="btn btn-primary py-3 px-5 me-3 animated fadeIn">SIGNUP</a>
                    <a href="login.html" class="btn btn-primary py-3 px-5 me-3 animated fadeIn">LOGIN</a>
                </div>
